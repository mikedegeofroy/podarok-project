            ...
            <div className="">
                ...
                <section>
                    <form onSubmit={onSubmit}>
                        <h3>Имя</h3>
                        <input autoComplete='off' className='font-["Roboto"] shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mb-6' name="username" />
                        <h3>Пол</h3>
